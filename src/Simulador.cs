...
class Simulador
{
    private const int TOTAL_TAREAS = 3000;
    ...
    private CancellationTokenSource _ctsPrecios; // TokenSource para controlar la actualización

    public async Task EjecutarPruebas()
    {
        Console.WriteLine("Iniciando simulador con mercado dinámico...");

        // Iniciar actualización de precios con cancelación
        ...
        {
            // Detener la actualización de precios
            _ctsPrecios.Cancel();
            try
            {
